...
const Resume = () => {
  ...
  return (
    <motion.div
      ...
      className="min-h-[80vh] flex items-center justify-center py-10 xl:py-4"
    >
      <div className="container mx-auto">
        ...
        >
          <TabsList className="flex flex-col w-full max-w-[360px] mx-auto xl:mx-0 gap-3 mt-6 xl:mt-16">
